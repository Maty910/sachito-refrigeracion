...
export const GuaranteeSection = () => {
  return (
    <section id="garantia" className="py-24 bg-surface-card relative overflow-hidden">
      {/* Decoración de fondo (Sello de agua) */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-text-main font-display mb-6">
            ...
            <span className="text-brand-primary">Respaldo Técnico.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <div className="bg-brand-dark border border-white/5 p-8 rounded-3xl hover:border-brand-accent/30 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-text-main mb-3 font-display">1 Año de Garantía</h3>
          ...
          <div className="bg-brand-dark border border-white/5 p-8 rounded-3xl hover:border-brand-accent/30 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-text-main mb-3 font-display">Matrícula CACAAV</h3>
            <p className="text-text-muted text-sm">
          ...
          <div className="bg-brand-dark border border-white/5 p-8 rounded-3xl hover:border-brand-accent/30 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-text-main mb-3 font-display">Informe Técnico</h3>
            <p className="text-text-muted text-sm">
          ...
          <div className="bg-brand-dark border border-white/5 p-8 rounded-3xl hover:border-brand-accent/30 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-text-main mb-3 font-display">Materiales de 1ra</h3>
            <p className="text-text-muted text-sm">
