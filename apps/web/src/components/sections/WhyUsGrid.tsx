...
export const WhyUsGrid = () => {
  return (
    // CAMBIO: Fondo CLARO (Ice) para cortar con tanto azul
    <section className="py-24 bg-surface-ice">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 auto-rows-fr">
          ...
          {/* Card Principal: Urgencias 
            CAMBIO: Fondo Oscuro para contrastar con el fondo claro de la sección
          */}
          <div className="md:col-span-2 bg-brand-dark rounded-3xl p-10 flex flex-col justify-between relative overflow-hidden group shadow-xl shadow-brand-dark/10">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 max-w-sm text-lg">
                Sabemos que el calor no espera. En temporada alta, priorizamos casos críticos (adultos mayores, comercios).
              </p>
            </div>
          ...
          {/* Card Herramientas 
            CAMBIO: Fondo BLANCO, Texto Oscuro. Padding unificado p-10.
          */}
          <div className="bg-white rounded-3xl p-10 border border-slate-100 shadow-xl shadow-slate-200/50 flex flex-col items-center text-center justify-center hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-text-muted-ice text-sm leading-relaxed">
              Bomba de vacío, nitrógeno, manifold digital. La tecnología hace la diferencia en la vida útil.
            </p>
          </div>

          {/* Card Zona 
            CAMBIO: Fondo BLANCO, Texto Oscuro.
          */}
          <div className="bg-white rounded-3xl p-10 border border-slate-100 shadow-xl shadow-slate-200/50 flex flex-col items-center text-center justify-center hover:-translate-y-1 transition-transform duration-300">
            <div className="bg-slate-50 p-4 rounded-full mb-6">
            ...
            <p className="text-text-muted-ice text-sm leading-relaxed">
              Castelar, Ituzaingó, Morón, Padua. Llegamos rápido porque estamos cerca.
            </p>
          </div>

          {/* Card Contacto 
              CAMBIO: Fondo CYAN (Accent) para romper la monotonía
           */}
          <div className="md:col-span-2 bg-brand-accent rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between shadow-xl shadow-cyan-500/20 relative overflow-hidden">
            ...
            <button 
              onClick={() => window.open('https://wa.me/123456789')}
              className="bg-brand-dark text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-brand-dark transition-all flex items-center gap-3 cursor-pointer shadow-lg"
            >
              <Phone size={20} /> Escribinos
            </button>
