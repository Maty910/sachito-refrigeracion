...
const FLOATING_WHATSAPP_URL = `https://wa.me/${COMPANY.contact.whatsapp.number}?text=${encodeURIComponent(COMPANY.contact.whatsapp.messages.default)}`;
...
export const FloatingWhatsApp = () => {
  return (
    ...
    >
      ...
      {/* Tooltip opcional */}
      <span className="absolute right-16 bg-white text-gray-800 text-xs font-bold px-3 py-1 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        ¡Escribinos!
      </span>
    </a>
  );
